...
from data.kaldi_io import read_mat_scp, read_mat_ark


def create_data_folder(feats_path, out_path, mat_type='scp'):
    """
    ...
    read_mat = read_mat_scp if mat_type == 'scp' else read_mat_ark
    

    for i, (sample_id, sample) in enumerate(read_mat(feats_path)):
